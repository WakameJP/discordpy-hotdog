...
#Global Chat System    
    GLOBAL_CH_NAME = "hotdog-global" # グローバルチャットのチャンネル名
    GLOBAL_WEBHOOK_NAME = "hotdog-global-webhook" # グローバルチャットのWebhook名
    ...
    if message.channel.name == GLOBAL_CH_NAME:
        ...
        for channel in global_channels:
            ...
            if webhook is None:
                # そのチャンネルに hotdog-global-webhook というWebhookは無かったので無視
                continue
