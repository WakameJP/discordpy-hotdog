...
@client.event
async def on_ready():
    await client.change_presence(activity=discord.Game(name='h?help | v1.4.2.1'))

    # or, for watching:
    activity = discord.Activity(name='h?help | v1.4.2.1 ', type=discord.ActivityType.playing)
